// ==UserScript==
    // @name         網頁簡轉繁 (台灣正體 - 純字元轉換) [完全內嵌版]
    // @name:en      Simplified to Traditional Chinese (TW Variant, Char-only) [Self-Contained]
    // @description  基於 Chinese_converter 的高性能網頁簡體轉繁體腳本，僅轉換字元，不處理地區詞彙。此版本已內嵌依賴庫，無需網路即可運行。
    // @description:en High-performance script to convert simplified Chinese to traditional Chinese. Dependencies are bundled for offline use.
    ...
    (function () {
        ...
        // =========================================================================
        // ===            START: ChineseConverter.js BUNDLED CODE                ===
        // === 將您在步驟 1 複製的 chinese-converter.js 完整程式碼貼在此處     ===
        // =========================================================================
...
// export { Chinese_converter };
        ...
        // =========================================================================
        // ===             END: ChineseConverter.js BUNDLED CODE                 ===
        // =========================================================================


        // =========================================================================
        // ===                  主腳本邏輯 (Main Script Logic)                   ===
        // =========================================================================

        // 由於庫代碼已內嵌，`ChineseConverter` 對象現在是全局可用的
        if (typeof ChineseConverter === 'undefined') {
            console.error('繁簡轉換腳本錯誤: ChineseConverter 依賴庫未能成功加載！');
            return; // 終止腳本執行
        }
